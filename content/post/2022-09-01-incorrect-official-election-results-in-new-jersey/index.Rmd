...
Evidently, these three towns are difficult to keep straight! One might wonder if this is the only time the results have been scrambled. Fortunately, 2005 (Governor) and 2006 (Senate) seem to be the only election years from between 2004 and 2021 which stand out as having a *clear* mistake:
```{r echo = FALSE}
egg_estell_summary |>
...
Anyway, I have sympathy. Dealing with heterogeneous data sets from multiple source is hard.
